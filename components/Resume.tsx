  ...
  return (
    <Tabs value={tab} onValueChange={onTabChange} defaultValue="experiences" className="md:gap-4 w-full lg:w-[900px] h-auto text-white-1 grid lg:grid-x-1-2">
      ...
      <TabsList className="flex gap-4 flex-col w-full h-auto justify-start">
        ...
        <p className="w-full lg:max-w-[250px] text-12">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, minus.</p>
      ...
      <div className="span-x-2">
            ...
            <h1 className="text-16">Experiencies</h1>
                <p className="text-12 text-white-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, animi.
